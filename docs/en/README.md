...
- Use [Zig Installation](./zig-installation.md) if a Debian source build needs Zig first
...
- [Zig Installation](./zig-installation.md)
...
1. NullClaw currently requires **Zig 0.16.0** (exact version); Debian setup is covered in [Zig Installation](./zig-installation.md).
